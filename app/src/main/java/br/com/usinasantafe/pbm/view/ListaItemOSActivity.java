    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemOSListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> l, View v, int position,
                ...
                pbmContext.getMecanicoCTR().getApontBean().setItemOSApontMecan(itemOSBean.getSeqItemOS());
                pbmContext.getMecanicoCTR().getApontBean().setParadaApontMecan(0L);
                pbmContext.getMecanicoCTR().getApontBean().setRealizApontMecan(0L);
